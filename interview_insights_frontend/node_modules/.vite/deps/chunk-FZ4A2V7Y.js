...
} from "./chunk-FOWA7LBK.js";
import {
  Stack_default
} from "./chunk-5TBCYFXD.js";
import {
  DAY_MARGIN,
...
var _excluded2 = ["value", "rangePosition", "onRangePositionChange", "toolbarFormat", "className", "onViewChange", "view", "views"];
...
var PickersRangeCalendarHeader = React9.forwardRef(function PickersRangeCalendarHeader2(props, ref) {
  const utils = useUtils();
  const translations = usePickersTranslations();
  const {
    calendars,
  ...
  if (calendars === 1) {
    return (0, import_jsx_runtime5.jsx)(PickersCalendarHeader, _extends({}, other, {
      labelId,
      ref
    }));
  }
  ...
  return (0, import_jsx_runtime5.jsx)(PickersRangeCalendarHeaderContentMultipleCalendars, _extends({}, otherRangeProps, {
    ref,
...
true ? PickersRangeCalendarHeader.propTypes = {
   ...
   */
  calendars: import_prop_types3.default.oneOf([1, 2, 3]).isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  month: import_prop_types3.default.object.isRequired,
  /**
   * Index of the month used for this header.
   */
  monthIndex: import_prop_types3.default.number.isRequired,
...
function useDateRangeCalendarDefaultizedProps(props, name) {
  ...
  return _extends({}, themeProps, {
    renderLoading: themeProps.renderLoading ?? (() => (0, import_jsx_runtime6.jsx)("span", {
      children: "..."
    })),
...
var DateRangeCalendar = React10.forwardRef(function DateRangeCalendar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsxs)(DateRangeCalendarRoot, _extends({
    ref,
    className: clsx_default(className, classes.root),
    ownerState
  }, other, {
    children: [(0, import_jsx_runtime6.jsx)(Watermark, {
      ...
      return (0, import_jsx_runtime6.jsxs)(DateRangeCalendarMonthContainer, {
        className: classes.monthContainer,
        children: [(0, import_jsx_runtime6.jsx)(CalendarHeader, _extends({}, calendarHeaderProps, {
          month,
          monthIndex,
          labelId
...
true ? DateRangeCalendar.propTypes = {
   ...
   * @default ['start', 'end']
   */
  availableRangePositions: import_prop_types4.default.arrayOf(import_prop_types4.default.oneOf(["end", "start"]).isRequired),
  /**
   * The number of calendars to render.
   * @default 2
   */
  calendars: import_prop_types4.default.oneOf([1, 2, 3]),
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * @default 1
   */
  currentMonthCalendarPosition: import_prop_types4.default.oneOf([1, 2, 3]),
  /**
   ...
   * @default 'start'
   */
  defaultRangePosition: import_prop_types4.default.oneOf(["end", "start"]),
  /**
   ...
   * @default false
   */
  disableAutoMonthSwitching: import_prop_types4.default.bool,
  /**
   ...
   * @default false
   */
  disableDragEditing: import_prop_types4.default.bool,
  /**
   ...
   */
  focusedView: import_prop_types4.default.oneOf(["day"]),
  /**
   ...
   */
  onRangePositionChange: import_prop_types4.default.func,
  /**
   ...
   */
  openTo: import_prop_types4.default.oneOf(["day"]),
  /**
   * The position in the currently edited date range.
   * Used when the component position is controlled.
   */
  rangePosition: import_prop_types4.default.oneOf(["end", "start"]),
  /**
   ...
   * Must be a valid option from `views` list.
   */
  view: import_prop_types4.default.oneOf(["day"]),
  /**
   * Available views.
   */
  views: import_prop_types4.default.arrayOf(import_prop_types4.default.oneOf(["day"]))
} : void 0;
...
var renderDateRangeViewCalendar = ({
  ...
  view,
  onViewChange
}) => (0, import_jsx_runtime7.jsx)(DateRangeCalendar, {
  value,
  defaultValue,
  referenceDate,
  onChange,
...
var useMultiInputFieldSelectedSections = (params) => {
  const unstableEndFieldRef = React12.useRef(null);
  const handleUnstableEndFieldRef = useForkRef(params.unstableEndFieldRef, unstableEndFieldRef);
  const [startSelectedSection, setStartSelectedSection] = React12.useState(params.selectedSections ?? null);
  const [endSelectedSection, setEndSelectedSection] = React12.useState(null);
...
var MultiInputDateRangeFieldRoot = styled_default(React13.forwardRef((props, ref) => (0, import_jsx_runtime8.jsx)(Stack_default, _extends({
  ref,
  spacing: 2,
  direction: "row",
  alignItems: "center"
...
var MultiInputDateRangeField = React13.forwardRef(function MultiInputDateRangeField2(inProps, ref) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiMultiInputDateRangeField"
  });
  ...
  return (0, import_jsx_runtime8.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime8.jsx)(TextField, _extends({
      fullWidth: true
    }, startDateProps)), (0, import_jsx_runtime8.jsx)(Separator, _extends({}, separatorProps)), (0, import_jsx_runtime8.jsx)(TextField, _extends({
      fullWidth: true
    }, endDateProps))]
  }));
});
true ? MultiInputDateRangeField.propTypes = {
  ...
  unstableEndFieldRef: import_prop_types5.default.oneOfType([import_prop_types5.default.func, import_prop_types5.default.object]),
  unstableStartFieldRef: import_prop_types5.default.oneOfType([import_prop_types5.default.func, import_prop_types5.default.object]),
  /**
...
var useMultiInputFieldSlotProps = ({
  ...
  const previousRangePosition = React14.useRef(rangePosition);
  React14.useEffect(() => {
    var _a;
    if (!open) {
      return;
...
var useEnrichedRangePickerFieldProps = (params) => {
  if (true) {
    const fieldTypeRef = React14.useRef(params.fieldType);
...
var useDesktopRangePicker = (_ref) => {
  ...
  const fieldContainerRef = React15.useRef(null);
  const anchorRef = React15.useRef(null);
  const popperRef = React15.useRef(null);
  const startFieldRef = React15.useRef(null);
  const endFieldRef = React15.useRef(null);
  const initialView = React15.useRef(props.openTo ?? null);
  ...
  const renderPicker = () => (0, import_jsx_runtime9.jsxs)(LocalizationProvider, {
    localeText,
    children: [(0, import_jsx_runtime9.jsx)(Field, _extends({}, enrichedFieldProps)), (0, import_jsx_runtime9.jsx)(PickersPopper, _extends({
      role: "tooltip",
...
// node_modules/@mui/x-date-pickers-pro/DesktopDateRangePicker/DesktopDateRangePicker.js
var DesktopDateRangePicker = React16.forwardRef(function DesktopDateRangePicker2(inProps, ref) {
  var _a;
...
var useMobileRangePicker = (_ref) => {
  ...
  const startFieldRef = React17.useRef(null);
  const endFieldRef = React17.useRef(null);
  const fieldType = slots.field.fieldType ?? "multi-input";
  const {
    rangePosition,
    onRangePositionChange
  ...
  const renderPicker = () => (0, import_jsx_runtime10.jsxs)(LocalizationProvider, {
    localeText,
    children: [(0, import_jsx_runtime10.jsx)(Field, _extends({}, enrichedFieldProps)), (0, import_jsx_runtime10.jsx)(PickersModalDialog, _extends({}, actions, {
      open,
      slots,
      slotProps,
...
// node_modules/@mui/x-date-pickers-pro/MobileDateRangePicker/MobileDateRangePicker.js
var MobileDateRangePicker = React18.forwardRef(function MobileDateRangePicker2(inProps, ref) {
  var _a;
...
var DateRangePicker = React19.forwardRef(function DateRangePicker2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
  ...
  if (isDesktop) {
    return (0, import_jsx_runtime11.jsx)(DesktopDateRangePicker, _extends({
      ref
    }, other));
  }
  return (0, import_jsx_runtime11.jsx)(MobileDateRangePicker, _extends({
    ref
  }, other));
});
...
@mui/x-license/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FZ4A2V7Y.js.map
