...
var ClassNameConfiguratorContext = React6.createContext(defaultContextValue);
if (true) {
...
function useClassNamesOverride(generateUtilityClass2) {
  ...
  } = React6.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React7.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React7.useEffect(() => {
  ...
  const updateRootElementName = React7.useCallback((instance) => {
...
var _excluded7 = ["children", "className", "component", "dense", "disablePadding", "subheader"];
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EUGDATGN.js.map
